...
<div>
    ...
    <div class="tw-space-y-2">
        <div id='all-bookings-calendar'>

        </div>
    </div>
    <div class="tw-space-y-2 tw-mt-8">
        <h3 id="all-bookings-title" class="tw-text-2xl tw-text-black tw-font-bold"></h3>
        <div id="all-bookings-filters" class="tw-hidden tw-grid tw-grid-cols-4 tw-gap-4 tw-p-4">
        ...
        <div id="users-all-bookings" class="tw-block"></div>
