<!-- email-templates/event-invitation-cancellation.php -->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Event Invitation Cancellation</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="content" style="background-color:#FBFBFB;color:#000000">
            ...
            <p>
                <?= sprintf(
                    __('Unfortunately, your invitation for «%s» has been cancelled.', 'spaces_mnu_plugin'),
