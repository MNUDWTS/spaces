<!-- email-templates/cancellation-booking-resource.php resource -->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Cancellation Booking Resource</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="content" style="background-color:#FBFBFB;color:#000000">
            ...
            <p>
                <?= sprintf(
                    __('Unfortunately, your booking «%s» has been cancelled due to — «%s».', 'spaces_mnu_plugin'),
                    '<span style="font-weight: 700;">' . $resource_name . '</span>',
                    '<span style="font-weight: 700; font-style: italic;">' . $cancel_comment . '</span>'
                ); ?>
            </p>
            <ul class="booking-details" style="list-style: none; padding: 0;">
                <li><?= __('Date', 'spaces_mnu_plugin') . ': ' . '<span style="font-weight: 700;">' . esc_html($date) . '</span>'; ?></li>
                <li class="slots-wrap">
