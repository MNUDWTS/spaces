<!-- email-templates/cancellation-booking-event.php -->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Cancellation Booking Event</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="content" style="background-color:#FBFBFB;color:#000000">
            ...
            <p>
                <?= sprintf(
                    __('Unfortunately, your registration for «%s» has been cancelled due to — «%s».', 'spaces_mnu_plugin'),
