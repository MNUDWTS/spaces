<!-- email-templates/success-booking-event.php event -->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Successful Event Booking</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="content" style="background-color:#FBFBFB;color:#000000">
            ...
            <p>
                <?= sprintf(
                    __('We inform you that your registration for the event «%s» was successful.', 'spaces_mnu_plugin'),
            ...
            <div style="width:100%; border-top: solid 1px; border-color: #EBEBEB;padding-top: 10px; margin-top:10px;">
                <p style="font-size: 12px;font-weight:300; color:#666666">
                    <?= sprintf(
                        __('If you have any questions regarding your registration, please, contact %s by email at %s.', 'spaces_mnu_plugin'),
